  ...
  return (
    <nav className='w-full flex justify-between border-b-[1px] border-opacity-30 border-[#b0a7a4] h-20 fixed z-50'>
        ...
        <div className='flex items-center border-l-[1px] border-opacity-30 border-[#b0a7a4] gap-8 px-8 flex-1'>
            <div className='navlink h-full flex items-center uppercase font-bold cursor-pointer border-transparent hover:border-[#B17075] border-b-2 opacity-0 translate-x-2'>New</div>
            <div className='navlink h-full flex items-center uppercase font-bold cursor-pointer border-transparent hover:border-[#B17075] border-b-2 opacity-0 translate-x-2'>Sale</div>
            <div className='navlink h-full flex items-center uppercase font-bold cursor-pointer border-transparent hover:border-[#B17075] border-b-2 opacity-0 translate-x-2'>Man</div>
            <div className='navlink h-full flex items-center uppercase font-bold cursor-pointer border-transparent hover:border-[#B17075] border-b-2 opacity-0 translate-x-2'>Women</div>
        </div>
